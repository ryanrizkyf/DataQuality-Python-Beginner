...
print('Shape awal Outliers: ', retail_raw.shape)
...
print('Shape akhir Outliers: ', retail_raw.shape)

# Tugas Praktek
# Setelah berhasil mengatasi missing value tadi,
# kita memutuskan untuk mencoba menemukan sejumlah outliers menggunakan IQR.
# Dengan begitu, aku bisa mengetahui berapa IQR dari variabel item_price.
# Q1, Q3, dan IQR
...
# Tugas Praktek
# Terakhir lagi menuju selesai! Kita tinggal membuang duplikasi data dari dataset retail_raw.
# Check ukuran (baris dan kolom) sebelum data duplikasi dibuang
print('Shape awal Deduplikasi Data: ', retail_raw.shape)

# Buang data yang terduplikasi
retail_raw.drop_duplicates(inplace=True)

# Check ukuran (baris dan kolom) setelah data duplikasi dibuang
print('Shape akhir Deduplikasi Data: ', retail_raw.shape)
